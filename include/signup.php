        ...
        <div class="d-flex flex-column justify-content-center">
            <div class="card bg-light mb-3 mt-4 mx-auto" style="width: 48rem;">
                ...
                <div class="card-body login-card-body">
                    <p class="login-box-msg">Sign up to get access to incredible quotes</p>

                    <form action="index.php?include=confirm-sign-up" method="post">
                        ...
                        <?php if (!empty($_GET['gagal'])) { ?>
                            ...
                            <?php } else { ?>
                                <span class="text-danger">Username is not available, please try again!</span>
                            <?php } ?>
                        <?php } ?>
